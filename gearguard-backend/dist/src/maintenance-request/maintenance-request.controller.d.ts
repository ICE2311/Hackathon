...
export declare class MaintenanceRequestController {
    private readonly maintenanceRequestService;
    constructor(maintenanceRequestService: MaintenanceRequestService);
    create(createDto: CreateMaintenanceRequestDto, req: any): Promise<{
        equipment: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    findAll(type?: MaintenanceType, stage?: RequestStage, maintenanceTeamId?: string, equipmentId?: string): Promise<({
        equipment: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    assignTechnician(id: string, assignDto: AssignTechnicianDto, req: any): Promise<{
        equipment: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    updateStage(id: string, updateStageDto: UpdateStageDto, req: any): Promise<{
        equipment: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
