...
async function main() {
    ...
    const request1 = await prisma.maintenanceRequest.create({
        data: {
            ...
            description: 'Industrial printer experiencing frequent paper jams. Needs inspection and cleaning.',
            type: client_1.MaintenanceType.CORRECTIVE,
    ...
    const request2 = await prisma.maintenanceRequest.create({
        data: {
            ...
            description: 'Scheduled quarterly preventive maintenance for CNC machine.',
            type: client_1.MaintenanceType.PREVENTIVE,
            equipmentId: equipment2.id,
            maintenanceTeamId: mechanicalTeam.id,
            assignedTechnicianId: technician2.id,
            scheduledDate: new Date('2025-01-15'),
            stage: client_1.RequestStage.NEW,
    ...
    const request3 = await prisma.maintenanceRequest.create({
        data: {
            ...
            description: 'Server rack cooling fan making unusual noise. Requires replacement.',
            type: client_1.MaintenanceType.CORRECTIVE,
